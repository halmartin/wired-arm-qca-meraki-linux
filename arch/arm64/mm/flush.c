...
void dma_map_area(const void *start, size_t size, int direction)
{
        __dma_map_area(start, size, direction);
}
EXPORT_SYMBOL(dma_map_area);

void dma_flush_range(const void *start, const void *end)
{
        __dma_flush_range(start, end);
}
EXPORT_SYMBOL(dma_flush_range);
