...
int qcom_scm_dload_read(u32 svc_id, u32 cmd_id, void *resp_buf)
{
	int ret;
	...
	ret = __qcom_scm_dload_read(__scm->dev, svc_id, cmd_id, resp_buf);
...
EXPORT_SYMBOL(qcom_scm_dload_read);
