...
#define PHY_ID_AQR111C_B0	0x03a1b7e2
#define PHY_ID_AQR112	0x03a1b660
#define PHY_ID_AQR112C	0x03a1b790
#define PHY_ID_AQR112C_B0	0x03a1b792
#define PHY_ID_AQR113C		0x31c31c10
#define PHY_ID_AQR113C_A1	0x31c31c11
#define PHY_ID_AQR113C_B0	0x31c31c12
#define PHY_ID_AQR114C		0x31c31c20
#define PHY_ID_AQR114C_A1	0x31c31c21
#define PHY_ID_AQR114C_B0	0x31c31c22
#define PHY_ID_AQR115C		0x31c31c30
#define PHY_ID_AQR115C_A1	0x31c31c31
#define PHY_ID_AQR115C_B0	0x31c31c32
...
{
	.phy_id		= PHY_ID_AQR111C_B0,
	.phy_id_mask	= 0xfffffff0,
	.name		= "Aquantia AQR111C B0",
	.features	= PHY_AQUANTIA_FEATURES,
	.flags		= PHY_HAS_INTERRUPT,
	.probe		= aquantia_phy_probe,
	.soft_reset	= aquantia_soft_reset,
...
{
	.phy_id		= PHY_ID_AQR112C_B0,
	.phy_id_mask	= 0xfffffff0,
	.name		= "Aquantia AQR112C B0",
	.features	= PHY_AQUANTIA_FEATURES,
	.flags		= PHY_HAS_INTERRUPT,
	.probe		= aquantia_phy_probe,
	.soft_reset = aquantia_soft_reset,
...
{
	.phy_id		= PHY_ID_AQR113C_A1,
	.phy_id_mask	= 0xfffffff0,
	.name		= "Aquantia AQR113C A1",
	.features	= PHY_AQUANTIA_FEATURES,
	.flags		= PHY_HAS_INTERRUPT,
	.probe		= aquantia_phy_probe,
	.soft_reset = aquantia_soft_reset,
...
{
	.phy_id		= PHY_ID_AQR113C_B0,
	.phy_id_mask	= 0xfffffff0,
	.name		= "Aquantia AQR113C B0",
	.features	= PHY_AQUANTIA_FEATURES,
	.flags		= PHY_HAS_INTERRUPT,
	.probe		= aquantia_phy_probe,
	.soft_reset = aquantia_soft_reset,
...
{
	.phy_id		= PHY_ID_AQR114C_A1,
	.phy_id_mask	= 0xfffffff0,
	.name		= "Aquantia AQR114C A1",
	.features	= PHY_AQUANTIA_FEATURES,
	.flags		= PHY_HAS_INTERRUPT,
	.probe		= aquantia_phy_probe,
	.soft_reset = aquantia_soft_reset,
...
{
	.phy_id		= PHY_ID_AQR114C_B0,
	.phy_id_mask	= 0xfffffff0,
	.name		= "Aquantia AQR114C B0",
	.features	= PHY_AQUANTIA_FEATURES,
	.flags		= PHY_HAS_INTERRUPT,
	.probe		= aquantia_phy_probe,
	.soft_reset = aquantia_soft_reset,
...
{
	.phy_id		= PHY_ID_AQR115C_A1,
	.phy_id_mask	= 0xfffffff0,
	.name		= "Aquantia AQR115C A1",
	.features	= PHY_AQUANTIA_FEATURES,
	.flags		= PHY_HAS_INTERRUPT,
	.probe		= aquantia_phy_probe,
	.soft_reset = aquantia_soft_reset,
...
{
	.phy_id		= PHY_ID_AQR115C_B0,
	.phy_id_mask	= 0xfffffff0,
	.name		= "Aquantia AQR115C B0",
	.features	= PHY_AQUANTIA_FEATURES,
	.flags		= PHY_HAS_INTERRUPT,
	.probe		= aquantia_phy_probe,
	.soft_reset = aquantia_soft_reset,
...
static struct mdio_device_id __maybe_unused aquantia_tbl[] = {
	...
	{ PHY_ID_AQR111C_B0, 0xfffffff0 },
	{ PHY_ID_AQR112, 0xfffffff0 },
	{ PHY_ID_AQR112C, 0xfffffff0 },
	{ PHY_ID_AQR112C_B0, 0xfffffff0 },
	{ PHY_ID_AQR113C, 0xfffffff0 },
	{ PHY_ID_AQR113C_A1, 0xfffffff0 },
	{ PHY_ID_AQR113C_B0, 0xfffffff0 },
	{ PHY_ID_AQR114C, 0xfffffff0 },
	{ PHY_ID_AQR114C_A1, 0xfffffff0 },
	{ PHY_ID_AQR114C_B0, 0xfffffff0 },
	{ PHY_ID_AQR115C, 0xfffffff0 },
	{ PHY_ID_AQR115C_A1, 0xfffffff0 },
	{ PHY_ID_AQR115C_B0, 0xfffffff0 },
	{ }
};
